- 👋 一只热爱代码的夜猫子，一个身在马来西亚的爱钱专家🐾
- 👀 目前已熟悉技能：web渗透、SEO、逆向入门、PHP开发、代码审计、AI训练
- 🌱 目前正在做的事：AI全栈探索，AI训练、大型AI模型安全审计绕过（GPT5.5，opus4.8等）
- 💞️ 目前在学习的技能：虚拟货币量化交易及自动化程序、
- 🌱 目前已完成的系统：高精度AI代码审计平台、漏洞提交平台、驱动级权限维持、团队协作渗透辅助平台开发
